        ...
        function obterResumoBonusDanoArma(arma) {
            const rotuloAtributo = formatarRotuloAtributo(arma?.ataque) || "-";
            const modificadorBase = getModificadorBaseAtributo(arma?.ataque);

            if (modificadorBase === null) {
                return {
                    rotuloAtributo,
                    totalDano: null,
                    textoResumo: rotuloAtributo
                };
            }

            return {
                rotuloAtributo,
                totalDano: modificadorBase,
                textoResumo: `${formatarBonusCalculado(modificadorBase)} (${rotuloAtributo})`
            };
        }
        ...
        function fecharModalAtaqueArma() {
            ...
            estadoAtaqueArma.textoResumoDano = "";
        ...
        function abrirModalAtaqueArma(arma) {
            ...
            const { textoResumo: textoResumoDano } = obterResumoBonusDanoArma(arma);
            ...
            estadoAtaqueArma.textoResumoDano = textoResumoDano;
