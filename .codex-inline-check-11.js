        ...
        function renderizarCardDetalheMagia(magia) {
            ...
            formatarTagsMagia(magia.tags).forEach(tag => {
        ...
        function montarModalMagia() {
            ...
            overlay.innerHTML = `
                <div class="magia-modal" role="dialog" aria-modal="true" aria-labelledby="magiaModalTitulo">
                    ...
                    <div id="magiaModalVisualizacao"></div>
                    <form id="magiaModalFormulario" class="magia-formulario oculto">
                        <div class="magia-formulario-grid">
                            ...
                            <div class="magia-formulario-campo">
                                ...
                                <input id="magiaModalEscola" type="text">
                            </div>
                            <div class="magia-formulario-campo">
                            ...
                            <div class="magia-formulario-campo completo">
                                <label for="magiaModalTags">Tags</label>
                                <input id="magiaModalTags" type="text" placeholder="Ex: ataque, dano, cura, ritual">
                            </div>
                            <div class="magia-formulario-campo">
                            ...
                            <div class="magia-formulario-campo">
                                ...
                                <input id="magiaModalDanoTipo" type="text" placeholder="Ex: necrÃ³tico">
                            </div>
                            <div class="magia-formulario-campo completo">
        ...
        function preencherFormularioMagia(magia) {
            ...
            document.getElementById("magiaModalTags").value = formatarTagsMagia(magia.tags).join(", ");
        ...
        function lerFormularioMagia() {
            const tags = document.getElementById("magiaModalTags").value
                .split(",")
                .map(tag => tag.trim())
                .filter(Boolean);
        ...
        function alternarModoModalMagia(modo) {
            ...
            formulario?.classList.toggle("oculto", modo !== "editar");
