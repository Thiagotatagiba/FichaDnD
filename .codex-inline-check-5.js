        ...
        function abrirEtapaDanoAtaque() {
            ...
            resumo.innerHTML = [
                ...
                `B̫nus: <span class="ataque-modal-resumo-destaque">${estadoAtaqueArma.totalAtaque >= 0 ? "+" : "-"}${Math.abs(estadoAtaqueArma.totalAtaque)} (${estadoAtaqueArma.rotuloAtributo})</span>`
            ].join(' | ');
